    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo e(route('materi.show',$d->id)); ?>" class="btn btn-outline-primary">Lihat Detail Modul</a>

                <form class="d-inline-block" action="<?php echo e(route('materi.destroy',$d->id)); ?>" method="post">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project ahir\resources\views/materi/index.blade.php ENDPATH**/ ?>