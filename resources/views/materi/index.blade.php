    ...
    @foreach ($data as $d)
        <tr>
            ...
            <td>
                ...
                <a href="{{route('materi.show',$d->id)}}" class="btn btn-outline-primary">Lihat Detail Modul</a>

                <form class="d-inline-block" action="{{route('materi.destroy',$d->id)}}" method="post">
